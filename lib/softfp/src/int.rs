...
impl CastFrom<u128> for u32 {
    fn cast_from(value: u128) -> u32 { value as u32 }
}

impl CastFrom<u32> for u64 {
    fn cast_from(value: u32) -> u64 { value as u64 }
}

impl CastFrom<u128> for u64 {
    fn cast_from(value: u128) -> u64 { value as u64 }
}

impl CastFrom<u32> for u128 {
    fn cast_from(value: u32) -> u128 { value as u128 }
}

impl CastFrom<u64> for u128 {
    fn cast_from(value: u64) -> u128 { value as u128 }
}
